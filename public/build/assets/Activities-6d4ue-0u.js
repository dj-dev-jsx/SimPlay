import{j as e,H as l,L as m}from"./app-DduNe8A5.js";import{S as x}from"./StudentLayout-CueucXuM.js";import"./user-BOvaNEfT.js";import"./chevron-down-CbIJabUT.js";import"./log-out-B1oHdiJS.js";function o({class:n,activities:s}){return e.jsx(x,{children:e.jsxs("div",{className:"min-h-screen bg-[#cfe9c8] flex justify-center px-4 py-8",children:[e.jsx(l,{title:"My Activities"}),e.jsxs("div",{className:"w-full max-w-7xl",children:[" ",e.jsxs("div",{className:"bg-[#3f5f1f] rounded-3xl px-6 py-5 mb-6 shadow-lg",children:[e.jsx("h1",{className:"text-2xl sm:text-3xl font-extrabold text-[#cfe9c8] text-center",children:n?.name}),e.jsx("p",{className:"text-center text-sm sm:text-base text-[#e6f3df] mt-1",children:"Your Activities"})]}),s.length===0?e.jsx("div",{className:"text-center text-gray-700 font-medium",children:"No activities available yet 🌱"}):e.jsx("div",{className:"grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6",children:s.map(t=>e.jsxs("div",{className:`
                    bg-white
                    rounded-3xl
                    shadow-xl
                    p-4 sm:p-6 md:p-8
